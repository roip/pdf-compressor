...
I've been using this to compress large PDFs to upload to various AI chats for summarizing and analysingm, 
its a simple script to compress PDF files using [Ghostscript](https://www.ghostscript.com/). 
